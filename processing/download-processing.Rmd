...
###To use groundhog, please: (1) make sure that you have the latest version of R/ RStudio installed; (2) install RTools
...
## If this line of code does not run, you can alternatively download the data via cyberduck

############################ this cell often does not work. Alternatively, you can copy-paste the raw data files into the data/raw folder
