...
**You will also need to install the AWS command-line interface (CLI) to be able to use the following code. To do so: try the instructions [in AWS documentation here](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html), or if you're familiar with installing things through Python's `pip`, [the instructions in this Github README](https://github.com/aws/aws-cli)**
